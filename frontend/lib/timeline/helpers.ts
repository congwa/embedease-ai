...
export function insertItem(state: TimelineState, item: TimelineItem): TimelineState {
...
export function getCurrentLlmCluster(state: TimelineState): LLMCallClusterItem | undefined {
...
export function removeWaitingItem(state: TimelineState, turnId: string): TimelineState {
